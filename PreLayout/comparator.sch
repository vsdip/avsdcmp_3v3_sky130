...
N 2520 -620 2520 -520 { lab=VOUT}
N 2110 -520 2110 -500 { lab=#net5}
N 2110 -440 2110 -400 { lab=GND}
N 2340 -520 2340 -400 { lab=GND}
N 2000 -810 2050 -810 { lab=VCC}
N 2000 -900 2000 -840 { lab=VCC}
N 2000 -780 2000 -660 { lab=VOUT2}
N 2000 -660 2110 -660 { lab=VOUT2}
N 2110 -620 2260 -620 { lab=VOUT2}
N 2340 -620 2520 -620 { lab=VOUT}
...
C {devices/isource.sym} 1300 -620 0 0 {name=Ihyst value="pwl 0 0 20u 0 21u 0.2u 40u 0.2u 41u 0.8u 60u 0.8u 61u 10u 100u 10u"}
...
C {devices/vsource.sym} 340 -1050 0 0 {name=V3 value="pwl 0 0.8 10u 1.8 20u 0.8 30u 1.8 40u 0.8 50u 1.8 60u 0.8 70u 1.8 80u 0.8 90u 1.8 100u 0.8"}
...
C {devices/vsource.sym} 340 -530 0 0 {name=V4 value="pwl 0 3.3 80u 3.3 81u 0 100u 0"}
C {devices/lab_pin.sym} 340 -560 0 0 {name=p23 lab=EN}
C {devices/lab_pin.sym} 340 -500 0 0 {name=p24 lab=GND}
C {devices/res.sym} 2520 -490 0 0 {name=LOAD
value=10M
footprint=1206
device=resistor
m=1}
...
C {devices/lab_pin.sym} 2050 -810 0 1 {name=p40 lab=VCC}
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 1980 -810 0 0 {name=M22
L=0.5
W=4
nf=1
mult=1
...
C {devices/lab_pin.sym} 1960 -810 0 0 {name=p42 lab=EN}
